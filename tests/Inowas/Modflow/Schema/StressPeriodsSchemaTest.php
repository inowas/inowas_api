...
class StressPeriodsSchemaTest extends BaseTestCase
{
    public function providerModel()
    {
        return [
            [
                file_get_contents('spec/example/modflow/stressPeriods.json'),
                file_get_contents('spec/schema/modflow/stressPeriods.json'),
                true
            ]
        ];
    }
