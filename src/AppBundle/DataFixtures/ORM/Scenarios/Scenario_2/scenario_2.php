...
class LoadScenario_2 implements FixtureInterface, ContainerAwareInterface
{
    ...
    public function load(ObjectManager $entityManager)
    {
        ...
        //   new Point(11777056.49104572273790836, 2403440.17028302047401667, 3857) : HTTP_4
        //   new Point(11784427.14815393835306168, 2396590.66674219723790884, 3857) : one_more
        //   new Point(11787540.82363948784768581, 2385794.83458124194294214, 3857) : H9
        //   new Point(11783036.01740818470716476, 2386882.81766726961359382, 3857) : Q68
        //   new Point(11775189.21765423379838467, 2396638.40362721262499690, 3857) : Q_62

        $observationPointPoints = array(
            array('name' => 'HTTP_4', 'point' => new Point(11777056.49104572273790836, 2403440.17028302047401667, 3857)),
            array('name' => 'one_more', 'point' => new Point(11784427.14815393835306168, 2396590.66674219723790884, 3857)),
            array('name' => 'H9', 'point' => new Point(11787540.82363948784768581, 2385794.83458124194294214, 3857)),
            array('name' => 'Q68', 'point' => new Point(11783036.01740818470716476, 2386882.81766726961359382, 3857)),
            array('name' => 'Q_62', 'point' => new Point(11775189.21765423379838467, 2396638.40362721262499690, 3857)),
        );
        ...
        {
            $observationPoint = new ObservationPoint($user, $project);
