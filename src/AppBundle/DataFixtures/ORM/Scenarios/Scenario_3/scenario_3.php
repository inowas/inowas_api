...
class LoadScenario_3 implements FixtureInterface, ContainerAwareInterface
{
    ...
    public function load(ObjectManager $entityManager)
    {
        ...
        $layer = GeologicalLayerFactory::setOwnerProjectNameAndPublic($user, $project, 'SC3_L1');
        $entityManager->persist($layer);
        $layer = GeologicalLayerFactory::setOwnerProjectNameAndPublic($user, $project, 'SC3_L2');
        $entityManager->persist($layer);
        $layer = GeologicalLayerFactory::setOwnerProjectNameAndPublic($user, $project, 'SC3_L3');
        $entityManager->persist($layer);
        $entityManager->flush();
        ...
        // Add new Area
        $area = AreaFactory::setOwnerProjectNameTypeAndPublic($user, $project, 'SC3_A1', $areaType);
        ...
        /** @var Polygon $polygon */
        $polygon = $converter->convertStringToPHPValue($polygonText);
        ...
        // Add new boundaries
        $boundary = BoundaryFactory::setOwnerProjectNameAndPublic($user, $project, 'SC3_B1');
        ...
        $boundary = BoundaryFactory::setOwnerProjectNameAndPublic($user, $project, 'SC3_B2');
