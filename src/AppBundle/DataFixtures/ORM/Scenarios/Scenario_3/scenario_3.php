...
class LoadScenario_3 implements FixtureInterface, ContainerAwareInterface
{
    ...
    public function load(ObjectManager $entityManager)
    {
        ...
        $boundary_1 = $this->addBoundary($boundaryText);
        $entityManager->persist($boundary_1);
        $this->addModelObjectPropertiesFromCSVFile($area, __DIR__.'/scenario_3_boundary_1_property_timeseries.csv', ';');
        ...
        $boundary_2 = $this->addBoundary($boundaryText);
        $entityManager->persist($boundary_2);
        $this->addModelObjectPropertiesFromCSVFile($area, __DIR__.'/scenario_3_boundary_2_property_timeseries.csv', ';');
