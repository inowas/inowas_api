...
class SoilmodelEventStoreTruncateCommand extends ContainerAwareCommand
{
    ...
    protected function configure(): void
    {
        ...
        $this
            ->setName('inowas:soilmodel:es:truncate')
            ->setDescription('Truncates the event-stream database of the soilmodel');
    }
