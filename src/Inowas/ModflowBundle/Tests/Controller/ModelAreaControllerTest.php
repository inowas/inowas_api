...
class ModelAreaControllerTest extends WebTestCase
{
    ...
    public function testGetAreaModelById() {
        ...
        $this->assertObjectHasAttribute('geojson', $response);
        $this->assertEquals('{"type":"Polygon","coordinates":[[[1,2],[2,2],[2,1],[1,1],[1,2]]]}', $response->geojson);
    }
