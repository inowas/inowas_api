...
use Inowas\Soilmodel\Model\Command\ChangeBoreLogLocation;
...
final class ChangeBoreLogLocationHandler
{
    ...
    public function __invoke(ChangeBoreLogLocation $command)
    {
        ...
        $boreLog->changeLocation($command->userId(), $command->location());
    }
}
