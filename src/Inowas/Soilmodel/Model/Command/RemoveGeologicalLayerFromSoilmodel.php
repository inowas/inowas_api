...
class RemoveGeologicalLayerFromSoilmodel extends Command implements PayloadConstructable
{

    use PayloadTrait;

    public static function byUserWithId(UserId $userId, SoilmodelId $id, GeologicalLayer $layer): RemoveGeologicalLayerFromSoilmodel
    {
        return new self(
            [
