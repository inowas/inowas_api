...
class SpecificStorageTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function test_store_an_array_value_with_layer_information(){
        $arr = [[1,2,3],[2,4,6]];
        $arr2 = [[2,3,4],[2,4,6]];
        $specificStorage = SpecificStorage::from2DArray($arr,LayerNumber::fromInteger(0));
        ...
        $this->assertEquals(true, $copyOfSpecificStorage->isArray());
