...
final class UpdateLayerHandler
{
    /** @var  LayersPersister */
    ...
    public function __invoke(UpdateLayer $command)
    {
        ...
        $modflowModel->updateLayer($command->userId(), $command->layerId(), $command->layer()->id(), $command->layer()->number(), $hash);
