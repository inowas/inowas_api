...
class LpfPackage implements \JsonSerializable
{
    ...
    {
        return array(
            'laytyp' => $this->laytyp->toReducedArray(),
            'layavg' => $this->layavg->toReducedArray(),
            'chani' => $this->chani->toReducedArray(),
            'layvka' => $this->layvka->toReducedArray(),
            'laywet' => $this->laywet->toReducedArray(),
            'ipakcb' => $this->ipakcb,
            'hdry' => $this->hdry,
            'iwdflg' => $this->iwdflg,
            'wetfct' => $this->wetfct,
            'iwetit' => $this->iwetit,
            'ihdwet' => $this->ihdwet,
            'hk' => $this->hk->toReducedArray(),
            'hani' => $this->hani->toReducedArray(),
            'vka' => $this->vka->toReducedArray(),
            'ss' => $this->ss->toReducedArray(),
            'sy' => $this->sy->toReducedArray(),
            'vkcb' => $this->vkcb->toReducedArray(),
            'wetdry' => $this->wetdry->toReducedArray(),
