...
class DisPackage implements \JsonSerializable
{
    ...
    public function jsonSerialize()
    {
        return array(
            ...
            'ncol' => $this->ncol,
            'nper' => $this->nper,
            'delr' => $this->delr->toReducedArray(),
            'delc' => $this->delc->toReducedArray(),
            'laycbd' => $this->laycbd->toReducedArray(),
            'top' => $this->top->toReducedArray(),
            'botm' => $this->botm->toReducedArray(),
            'perlen' => $this->perlen->toReducedArray(),
            'nstp' => $this->nstp->toReducedArray(),
            'tsmult' => $this->tsmult->toReducedArray(),
            'steady' => $this->steady->toReducedArray(),
            'itmuni' => $this->itmuni,
            'lenuni' => $this->lenuni,
