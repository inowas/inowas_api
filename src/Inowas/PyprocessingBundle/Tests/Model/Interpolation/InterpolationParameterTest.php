...
use Inowas\PyprocessingBundle\Model\Interpolation\InterpolationParameter;
...
class InterpolationParameterTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testInstantiate(){
        $this->assertInstanceOf(InterpolationParameter::class, $this->interpolationParameter);
