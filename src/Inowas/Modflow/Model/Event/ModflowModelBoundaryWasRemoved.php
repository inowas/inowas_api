...
class ModflowModelBoundaryWasRemoved extends AggregateChanged
{
    ...
    public static function withBoundaryId(ModflowModelId $modflowModelId, BoundaryId $boundaryId): ModflowModelBoundaryWasRemoved
    {
        $event = self::occur(
